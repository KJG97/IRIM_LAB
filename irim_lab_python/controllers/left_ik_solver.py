...
class KinematicsSolver(ArticulationKinematicsSolver):
    def __init__(self, robot_articulation: Articulation, end_effector_frame_name: Optional[str] = None) -> None:
        ...
        self._left_arm_subset = ArticulationSubset(robot_articulation, self._right_arm_joint_names)
        
        extension_root = _get_extension_root()
        robot_desc_path = os.path.join(extension_root, "rmpflow", "allex_left_arm_descriptor.yaml")
        ...
        if end_effector_frame_name is None:
            end_effector_frame_name = "left_hand"
    ...
    def compute_inverse_kinematics(self, target_position, target_orientation=None):
        ...
        if success and actions is not None:
            ...
            full_action = self._left_arm_subset.make_articulation_action(
